...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as LegalogyApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as LegalogyApp).resetToolStream();
  (state as unknown as LegalogyApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as LegalogyApp;
