...
# Output:
# - dist/Legalogy.app
# - dist/Legalogy-<version>.zip
# - dist/Legalogy-<version>.dmg
...
APP="$ROOT_DIR/dist/Legalogy.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Legalogy-$VERSION.zip"
DMG="$ROOT_DIR/dist/Legalogy-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Legalogy-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Legalogy-$VERSION.dSYM.zip"
