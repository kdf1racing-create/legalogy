...
if [[ -z "$version_content" ]]; then
  echo "<h2>Legalogy $VERSION</h2>"
  echo "<p>Latest Legalogy update.</p>"
  echo "<p><a href=\"https://github.com/legalogy/legalogy/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
