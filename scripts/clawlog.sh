...
show_usage() {
    cat << EOF
clawlog - Legalogy Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Legalogy logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Legalogy logs flow through the macOS unified log (subsystem: ai.legalogy).
