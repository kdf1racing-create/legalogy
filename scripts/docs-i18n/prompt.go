...
- Keep product names in English: Legalogy, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Legalogy Gateway, use “Gateway 网关”.
