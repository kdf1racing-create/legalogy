...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "legalogy", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Legalogy. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Legalogy Issue Label Audit");
