...
1. Download the runtime for your OS (extracts into `~/.legalogy/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.legalogy/tools/sherpa-onnx-tts/models`)

Update `~/.legalogy/legalogy.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.legalogy/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.legalogy/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
