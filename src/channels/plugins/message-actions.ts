...
export function listChannelMessageActions(cfg: LegalogyConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: LegalogyConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: LegalogyConfig): boolean {
  for (const plugin of listChannelPlugins()) {
