...
export type ChannelAgentToolFactory = (params: { cfg?: LegalogyConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: LegalogyConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: LegalogyConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: LegalogyConfig }) => boolean;
  supportsCards?: (params: { cfg: LegalogyConfig }) => boolean;
