...
function setSlackDmPolicy(cfg: LegalogyConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Legalogy";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Legalogy`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: LegalogyConfig, allowFrom: string[]): LegalogyConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
