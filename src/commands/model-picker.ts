...
type PromptDefaultModelResult = { model?: string; config?: LegalogyConfig };
...
function resolveConfiguredModelRaw(cfg: LegalogyConfig): string {
...
function resolveConfiguredModelKeys(cfg: LegalogyConfig): string[] {
...
export function applyPrimaryModel(cfg: LegalogyConfig, model: string): LegalogyConfig {
...
export function applyModelAllowlist(cfg: LegalogyConfig, models: string[]): LegalogyConfig {
  const defaults = cfg.agents?.defaults;
