...
const ensureLegalogyModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveLegalogyAgentDir = vi.fn().mockReturnValue("/tmp/legalogy-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/legalogy-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureLegalogyModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveLegalogyAgentDir,
}));
