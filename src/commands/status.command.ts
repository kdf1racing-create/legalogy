...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Legalogy status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("legalogy security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("legalogy security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.legalogy.ai/faq");
  runtime.log("Troubleshooting: https://docs.legalogy.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("legalogy status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("legalogy logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("legalogy status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("legalogy gateway probe")}`);
  }
}
