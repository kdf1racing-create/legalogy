...
export function applyOpenrouterProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: LegalogyConfig): LegalogyConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: LegalogyConfig): LegalogyConfig {
...
export function applyMoonshotConfig(cfg: LegalogyConfig): LegalogyConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: LegalogyConfig): LegalogyConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: LegalogyConfig): LegalogyConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: LegalogyConfig): LegalogyConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: LegalogyConfig): LegalogyConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: LegalogyConfig): LegalogyConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: LegalogyConfig): LegalogyConfig {
 ...
 */
export function applyHuggingfaceConfig(cfg: LegalogyConfig): LegalogyConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: LegalogyConfig): LegalogyConfig {
...
export function applyQianfanProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: LegalogyConfig): LegalogyConfig {
