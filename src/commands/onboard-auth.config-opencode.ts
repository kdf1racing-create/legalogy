...
export function applyOpencodeZenProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
...
export function applyOpencodeZenConfig(cfg: LegalogyConfig): LegalogyConfig {
