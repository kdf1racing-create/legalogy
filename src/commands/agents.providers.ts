...
function resolveDefaultAccountId(cfg: LegalogyConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: LegalogyConfig): boolean {
...
export function summarizeBindings(cfg: LegalogyConfig, bindings: AgentBinding[]): string[] {
