...
export function applyVercelAiGatewayProviderConfig(cfg: LegalogyConfig): LegalogyConfig {
...
export function applyVercelAiGatewayConfig(cfg: LegalogyConfig): LegalogyConfig {
