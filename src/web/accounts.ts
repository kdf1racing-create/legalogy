...
function listConfiguredAccountIds(cfg: LegalogyConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: LegalogyConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: LegalogyConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: LegalogyConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: LegalogyConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: LegalogyConfig): ResolvedWhatsAppAccount[] {
