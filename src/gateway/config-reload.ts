...
import type { LegalogyConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: LegalogyConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: LegalogyConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: LegalogyConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: LegalogyConfig) => void;
  log: {
