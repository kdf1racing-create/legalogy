...
import { type LegalogyConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: LegalogyConfig): string[] {
...
export function listAgentsForGateway(cfg: LegalogyConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: LegalogyConfig): string {
...
function resolveSessionStoreAgentId(cfg: LegalogyConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: LegalogyConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: LegalogyConfig): GatewaySessionsDefaults {
