...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @legalogy/voice-call -> voice-call).
...
export function discoverLegalogyPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".legalogy", "extensions")];
