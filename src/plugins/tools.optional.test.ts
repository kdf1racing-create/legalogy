...
const loadLegalogyPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadLegalogyPlugins: (params: unknown) => loadLegalogyPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadLegalogyPluginsMock.mockReturnValue(registry);
  return registry;
}

describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadLegalogyPluginsMock.mockReset();
  });
