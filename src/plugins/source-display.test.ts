...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/legalogy/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/legalogy/extensions",
        global: "/Users/x/.legalogy/extensions",
        workspace: "/Users/x/ws/.legalogy/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.legalogy/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/legalogy/extensions",
        global: "/Users/x/.legalogy/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.legalogy/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/legalogy/extensions",
        global: "/Users/x/.legalogy/extensions",
