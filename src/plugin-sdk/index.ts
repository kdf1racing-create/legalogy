...
export type { LegalogyConfig } from "../config/config.js";
/** @deprecated Use LegalogyConfig instead */
export type { LegalogyConfig as ClawdbotConfig } from "../config/config.js";
