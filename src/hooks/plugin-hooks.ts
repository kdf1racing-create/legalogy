...
import type { LegalogyPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: LegalogyPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: LegalogyPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
