...
export function listSignalAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: LegalogyConfig): string {
...
function mergeSignalAccountConfig(cfg: LegalogyConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: LegalogyConfig): ResolvedSignalAccount[] {
