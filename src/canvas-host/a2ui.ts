...
export const A2UI_PATH = "/__legalogy__/a2ui";

export const CANVAS_HOST_PATH = "/__legalogy__/canvas";

export const CANVAS_WS_PATH = "/__legalogy__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.legalogyCanvasA2UIAction.postMessage(...)
  // - Android: window.legalogyCanvasA2UIAction.postMessage(...)
  const handlerNames = ["legalogyCanvasA2UIAction"];
  ...
  globalThis.Legalogy = globalThis.Legalogy ?? {};
  globalThis.Legalogy.postMessage = postToNode;
  globalThis.Legalogy.sendUserAction = sendUserAction;
  globalThis.legalogyPostMessage = postToNode;
  globalThis.legalogySendUserAction = sendUserAction;
