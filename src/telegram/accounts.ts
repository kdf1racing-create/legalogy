...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.LEGALOGY_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: LegalogyConfig): string {
...
function mergeTelegramAccountConfig(cfg: LegalogyConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: LegalogyConfig): ResolvedTelegramAccount[] {
