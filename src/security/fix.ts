...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof LegalogyConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: LegalogyConfig; env: NodeJS.ProcessEnv }): {
  cfg: LegalogyConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
