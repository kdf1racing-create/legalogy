...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@legalogy", { botUsername: "legalogy" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@legalogy args", {
        botUsername: "legalogy",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@legalogy: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "legalogy" })).toBe(
      "/help@otherbot",
    );
  });
