...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/legalogy/legalogy/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.LEGALOGY_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.legalogy/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: LegalogyConfig = {
    ...params.cfg,
