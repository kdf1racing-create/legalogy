...
export function listBindings(cfg: LegalogyConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: LegalogyConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: LegalogyConfig) {
