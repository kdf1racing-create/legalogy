...
export function listIMessageAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: LegalogyConfig): string {
...
function mergeIMessageAccountConfig(cfg: LegalogyConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: LegalogyConfig): ResolvedIMessageAccount[] {
