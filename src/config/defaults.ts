...
function resolveAnthropicDefaultAuthMode(cfg: LegalogyConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: LegalogyConfig): LegalogyConfig {
...
export function applyTalkApiKey(config: LegalogyConfig): LegalogyConfig {
...
export function applyModelDefaults(cfg: LegalogyConfig): LegalogyConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: LegalogyConfig): LegalogyConfig {
...
export function applyLoggingDefaults(cfg: LegalogyConfig): LegalogyConfig {
...
export function applyContextPruningDefaults(cfg: LegalogyConfig): LegalogyConfig {
...
export function applyCompactionDefaults(cfg: LegalogyConfig): LegalogyConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
