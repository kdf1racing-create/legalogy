...
describe("createLegalogyCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createLegalogyCodingTools({
      config,
    ...
    const anthropicTools = createLegalogyCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createLegalogyCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createLegalogyCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
