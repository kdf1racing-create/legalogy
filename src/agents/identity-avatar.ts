...
function resolveAvatarSource(cfg: LegalogyConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: LegalogyConfig, agentId: string): AgentAvatarResolution {
