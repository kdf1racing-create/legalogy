...
export function resolveSessionToolsVisibility(cfg: LegalogyConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: LegalogyConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: LegalogyConfig): AgentToAgentPolicy {
