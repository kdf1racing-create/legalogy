...
function resolveWatchPaths(workspaceDir: string, config?: LegalogyConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: LegalogyConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: LegalogyConfig }) {
