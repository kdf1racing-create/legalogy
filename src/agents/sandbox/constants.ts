...
export const DEFAULT_SANDBOX_IMAGE = "legalogy-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "legalogy-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "legalogy-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "legalogy-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "legalogy-sbx-browser-";
