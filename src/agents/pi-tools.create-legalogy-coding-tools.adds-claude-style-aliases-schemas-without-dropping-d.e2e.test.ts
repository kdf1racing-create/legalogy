...
describe("createLegalogyCodingTools", () => {
  it("keeps read tool image metadata intact", async () => {
    ...
    const tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "legalogy-read-"));
    try {
  ...
  it("returns text content without image blocks for text files", async () => {
    ...
    try {
      ...
      const contents = "Hello from legalogy read tool.";
  ...
  it("filters tools by sandbox policy", () => {
    ...
    const tools = createLegalogyCodingTools({ sandbox });
