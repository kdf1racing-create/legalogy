...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.LEGALOGY_STATE_DIR;
  const configPath = env.LEGALOGY_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    LEGALOGY_PROFILE: profile,
    LEGALOGY_STATE_DIR: stateDir,
    LEGALOGY_CONFIG_PATH: configPath,
    LEGALOGY_GATEWAY_PORT: String(port),
    LEGALOGY_GATEWAY_TOKEN: token,
    LEGALOGY_LAUNCHD_LABEL: resolvedLaunchdLabel,
    LEGALOGY_SYSTEMD_UNIT: systemdUnit,
    LEGALOGY_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    LEGALOGY_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    LEGALOGY_STATE_DIR: stateDir,
    LEGALOGY_CONFIG_PATH: configPath,
    LEGALOGY_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    LEGALOGY_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    LEGALOGY_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    LEGALOGY_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    LEGALOGY_LOG_PREFIX: "node",
    LEGALOGY_SERVICE_MARKER: NODE_SERVICE_MARKER,
    LEGALOGY_SERVICE_KIND: NODE_SERVICE_KIND,
    LEGALOGY_SERVICE_VERSION: VERSION,
  };
}
