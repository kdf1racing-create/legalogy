...
export function listSlackAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: LegalogyConfig): string {
...
function mergeSlackAccountConfig(cfg: LegalogyConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: LegalogyConfig): ResolvedSlackAccount[] {
