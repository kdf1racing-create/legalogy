...
${formatHelpExamples([
  ['legalogy message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'legalogy message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'legalogy message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.legalogy.ai/cli/message")}`,
    )
    .action(() => {
