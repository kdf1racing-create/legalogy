...
const SANDBOX_EXAMPLES = {
  main: [
    ["legalogy sandbox list", "List all sandbox containers."],
    ["legalogy sandbox list --browser", "List only browser containers."],
    ["legalogy sandbox recreate --all", "Recreate all containers."],
    ["legalogy sandbox recreate --session main", "Recreate a specific session."],
    ["legalogy sandbox recreate --agent mybot", "Recreate agent containers."],
    ["legalogy sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["legalogy sandbox list", "List all sandbox containers."],
    ["legalogy sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["legalogy sandbox recreate --all", "Recreate all containers."],
    ["legalogy sandbox recreate --session main", "Recreate a specific session."],
    ["legalogy sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["legalogy sandbox recreate --browser --all", "Recreate only browser containers."],
    ["legalogy sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["legalogy sandbox explain", "Show effective sandbox config."],
    ["legalogy sandbox explain --session agent:main:main", "Explain a specific session."],
    ["legalogy sandbox explain --agent work", "Explain an agent sandbox."],
    ["legalogy sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.legalogy.ai/cli/sandbox")}\n`,
    )
    .action(() => {
