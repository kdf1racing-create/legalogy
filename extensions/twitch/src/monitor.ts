...
import type { ReplyPayload, LegalogyConfig } from "legalogy/plugin-sdk";
import { createReplyPrefixOptions } from "legalogy/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as LegalogyConfig;
