...
export function listZalouserAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: LegalogyConfig): string {
...
function mergeZalouserAccountConfig(cfg: LegalogyConfig, accountId: string): ZalouserAccountConfig {
