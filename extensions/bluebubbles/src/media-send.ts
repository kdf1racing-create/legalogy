import { resolveChannelMediaMaxBytes, type LegalogyConfig } from "legalogy/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: LegalogyConfig; accountId?: string }): string[] {
