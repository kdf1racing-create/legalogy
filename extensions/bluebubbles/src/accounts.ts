...
export function listBlueBubblesAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: LegalogyConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: LegalogyConfig): ResolvedBlueBubblesAccount[] {
