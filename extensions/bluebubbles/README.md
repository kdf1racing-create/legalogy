...
This directory contains the **BlueBubbles external channel plugin** for Legalogy.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `legalogy/plugin-sdk` helpers.
