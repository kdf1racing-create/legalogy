...
Nostr DM channel plugin for Legalogy using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Legalogy. It enables your bot to:
...
# Configure legalogy to use local relay
