import type { ChannelOnboardingAdapter, LegalogyConfig, WizardPrompter } from "legalogy/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.legalogy.ai/channels/mattermost",
    ].join("\n"),
