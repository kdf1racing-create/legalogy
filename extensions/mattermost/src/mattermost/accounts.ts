...
export function listMattermostAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: LegalogyConfig): string {
...
export function listEnabledMattermostAccounts(cfg: LegalogyConfig): ResolvedMattermostAccount[] {
