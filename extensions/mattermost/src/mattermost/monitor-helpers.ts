...
export { createDedupeCache, rawDataToString } from "legalogy/plugin-sdk";
...
export function resolveIdentityName(cfg: LegalogyConfig, agentId: string): string | undefined {
