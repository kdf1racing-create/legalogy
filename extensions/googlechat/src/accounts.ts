...
export function listGoogleChatAccountIds(cfg: LegalogyConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: LegalogyConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: LegalogyConfig): ResolvedGoogleChatAccount[] {
