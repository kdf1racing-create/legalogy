...
- Version alignment with core Legalogy release numbers.
...
- First public release of the @legalogy/voice-call plugin.
...
- CLI: `legalogy voicecall` commands (call/start/continue/speak/end/status/tail/expose).
