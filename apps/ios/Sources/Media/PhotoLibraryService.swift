...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: LegalogyPhotosLatestParams) async throws -> LegalogyPhotosLatestPayload {
        ...
        var results: [LegalogyPhotoPayload] = []
        ...
        return LegalogyPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> LegalogyPhotoPayload
    {
