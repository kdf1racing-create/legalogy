...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = LegalogyLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = LegalogyLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.legalogy.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(LegalogyLocationMode.off.rawValue)
                            Text("While Using").tag(LegalogyLocationMode.whileUsing.rawValue)
                            Text("Always").tag(LegalogyLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while Legalogy is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = LegalogyLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: LegalogyLocationMode {
        LegalogyLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
