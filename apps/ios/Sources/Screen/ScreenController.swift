...
final class ScreenController {
    ...
    /// Callback invoked when an legalogy:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = LegalogyKitResources.bundle
...
/// Handles navigation policy to intercept legalogy:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept legalogy:// deep links.
        if url.scheme?.lowercased() == "legalogy" {
