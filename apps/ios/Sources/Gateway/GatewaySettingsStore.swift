...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.legalogy.gateway"
    private static let nodeService = "ai.legalogy.node"
    private static let talkService = "ai.legalogy.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.legalogy.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.legalogy.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("legalogy-gateway.log")
    }
