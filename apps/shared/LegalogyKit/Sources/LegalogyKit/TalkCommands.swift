...
public enum LegalogyTalkCommand: String, Codable, Sendable {
...
public struct LegalogyTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct LegalogyTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
