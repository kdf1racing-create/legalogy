...
public enum LegalogyCanvasA2UICommand: String, Codable, Sendable {
...
public struct LegalogyCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct LegalogyCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
