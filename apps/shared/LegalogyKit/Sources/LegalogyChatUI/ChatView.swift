...
@MainActor
public struct LegalogyChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: LegalogyChatViewModel
    ...
    public init(
        viewModel: LegalogyChatViewModel,
    ...
    private var visibleMessages: [LegalogyChatMessage] {
        let base: [LegalogyChatMessage]
    ...
    private func mergeToolResults(in messages: [LegalogyChatMessage]) -> [LegalogyChatMessage] {
        ...
        for message in messages {
            ...
            let merged = LegalogyChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: LegalogyChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: LegalogyChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: LegalogyChatMessage) -> String {
