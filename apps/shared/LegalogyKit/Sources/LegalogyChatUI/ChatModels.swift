...
public typealias LegalogyPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias LegalogyPlatformImage = UIImage
#endif

public struct LegalogyChatUsageCost: Codable, Hashable, Sendable {
...
public struct LegalogyChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: LegalogyChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(LegalogyChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct LegalogyChatMessageContent: Codable, Hashable, Sendable {
...
public struct LegalogyChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [LegalogyChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: LegalogyChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [LegalogyChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: LegalogyChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(LegalogyChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([LegalogyChatMessageContent].self, forKey: .content) {
...
public struct LegalogyChatHistoryPayload: Codable, Sendable {
...
public struct LegalogySessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct LegalogySessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [LegalogySessionPreviewItem]
}

public struct LegalogySessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [LegalogySessionPreviewEntry]

    public init(ts: Int, previews: [LegalogySessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct LegalogyChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct LegalogyChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct LegalogyAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct LegalogyChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct LegalogyGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct LegalogyPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: LegalogyPlatformImage?
...
public struct LegalogyChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
