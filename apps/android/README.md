## Legalogy Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_legalogy-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm legalogy gateway --port 18789 --verbose
```
