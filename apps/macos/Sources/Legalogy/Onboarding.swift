...
enum UIStrings {
    static let welcomeTitle = "Welcome to Legalogy"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "legalogy.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: LegalogyOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: LegalogyChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g legalogy@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: LegalogyChatViewModel(
