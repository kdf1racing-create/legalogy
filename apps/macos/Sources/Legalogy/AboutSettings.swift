...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/legalogy/legalogy") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/legalogy/legalogy")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://legalogy.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "LegalogyBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "LegalogyBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "LegalogyGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "LegalogyGitCommit") as? String) ??
            "unknown"
    }
