...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.legalogy", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".legalogy/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.legalogyCommand(
            subcommand: "gateway",
