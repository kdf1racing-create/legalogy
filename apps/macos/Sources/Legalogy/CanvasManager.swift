...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.legalogy", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Legalogy/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__legalogy__/a2ui/").absoluteString + "?platform=macos"
    }
