...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Legalogy token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: LegalogyOAuthStore.AnthropicOAuthStatus = LegalogyOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.legalogy", category: "anthropic-oauth")
...
enum LegalogyOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let legalogyOAuthDirEnv = "LEGALOGY_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Legalogy OAuth token file not found"
            case .unreadableFile: "Legalogy OAuth token file not readable"
            case .invalidJSON: "Legalogy OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Legalogy OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Legalogy OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.legalogyOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".legalogy", isDirectory: true)
