...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.legalogy", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Legalogy windows, but below the system’s pop-up menus.
