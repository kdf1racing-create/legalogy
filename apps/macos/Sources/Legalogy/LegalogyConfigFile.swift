...
enum LegalogyConfigFile {
    private static let logger = Logger(subsystem: "ai.legalogy", category: "config")
    ...
    static func stateDirURL() -> URL {
        LegalogyPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        LegalogyPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-legalogy-config-file",
            "event": "config.write",
