...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.legalogy", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.legalogy", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [LegalogyChatMessage] = messages.compactMap { item in
