...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .legalogySelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? LegalogyPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? LegalogyPaths.stateDirURL.path
...
extension Notification.Name {
    static let legalogySelectSettingsTab = Notification.Name("legalogySelectSettingsTab")
}
