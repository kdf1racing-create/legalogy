...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.legalogy", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return LegalogyConfigFile.defaultWorkspaceURL() }
