...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = LegalogyConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = LegalogyConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = LegalogyConfigFile.loadDict()
            ...
            LegalogyConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/legalogy"
        state.remoteCliPath = ""
        return state
    }
}
