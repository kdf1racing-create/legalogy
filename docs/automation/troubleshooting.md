...
legalogy system heartbeat last
legalogy logs --follow
legalogy config get agents.defaults.heartbeat
legalogy channels status --probe
```
...
```bash
legalogy config get agents.defaults.heartbeat.activeHours
legalogy config get agents.defaults.heartbeat.activeHours.timezone
legalogy config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
legalogy cron list
legalogy logs --follow
```
