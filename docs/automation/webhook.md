...
read_when:
  ...
  - Wiring external systems into Legalogy
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Legalogy config directory (typically `~/.legalogy/hooks/transforms`).
...
- `legalogy webhooks gmail setup` writes `hooks.gmail` config for `legalogy webhooks gmail run`.
