...
Legalogy treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.legalogy/settings/voicewake.json`

Shape:

```json
{ "triggers": ["legalogy", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
