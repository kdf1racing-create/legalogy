...
This guide summarizes a sane workflow for working on the pi integration in Legalogy.
...
- Trigger the agent directly:
  - `pnpm legalogy agent --message "Hello" --thinking low`
...
State lives under the Legalogy state directory. Default is `~/.legalogy`. If `LEGALOGY_STATE_DIR` is set, use that directory instead.

To reset everything:

- `legalogy.json` for config
...
- [https://docs.legalogy.ai/testing](https://docs.legalogy.ai/testing)
- [https://docs.legalogy.ai/start/getting-started](https://docs.legalogy.ai/start/getting-started)
