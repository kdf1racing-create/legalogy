---
summary: "Use Synthetic's Anthropic-compatible API in Legalogy"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Legalogy registers it as the
...
Note: Legalogy's Anthropic client appends `/v1` to the base URL, so use
