---
summary: "Use NVIDIA's OpenAI-compatible API in Legalogy"
read_when:
  - You want to use NVIDIA models in Legalogy
...
legalogy onboard --auth-choice skip
legalogy models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
