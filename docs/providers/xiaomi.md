---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Legalogy"
read_when:
  - You want Xiaomi MiMo models in Legalogy
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Legalogy uses
