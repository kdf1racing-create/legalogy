...
You can point Legalogy at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Legalogy
...
- [Anthropic provider](/providers/anthropic) - Native Legalogy integration with Claude setup-token or API keys
