---
summary: "Use Qianfan's unified API to access many models in Legalogy"
read_when:
...
3. Legalogy installed on your system
...
4. Copy the API key for use with Legalogy

## CLI setup

```bash
legalogy onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Legalogy Configuration](/gateway/configuration)
