---
summary: "Use Qwen OAuth (free tier) in Legalogy"
read_when:
  - You want to use Qwen with Legalogy
...
If you already logged in with the Qwen Code CLI, Legalogy will sync credentials
