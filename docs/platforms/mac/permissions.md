...
- Same path: run the app from a fixed location (for Legalogy, `dist/Legalogy.app`).
...
Workaround: move files into the Legalogy workspace (`~/.legalogy/workspace`) if you want to avoid per-folder grants.
