...
本指南总结了在 Legalogy 中开发 Pi 集成的合理工作流程。
...
状态存储在 Legalogy 状态目录下。默认为 `~/.legalogy`。如果设置了 `LEGALOGY_STATE_DIR`，则使用该目录。
...
- https://docs.legalogy.ai/testing
- https://docs.legalogy.ai/start/getting-started
