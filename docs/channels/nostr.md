...
read_when:
  - You want Legalogy to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Legalogy to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`legalogy onboard`) and `legalogy channels add` list optional channel plugins.
...
```bash
legalogy plugins install @legalogy/nostr
```

Use a local checkout (dev workflows):

```bash
legalogy plugins install --link <path-to-legalogy>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "legalogy",
        "displayName": "Legalogy",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "legalogy@example.com",
        "lud16": "legalogy@example.com"
      }
    }
  }
}
