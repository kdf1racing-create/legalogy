...
- Install via CLI: `legalogy plugins install @legalogy/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `legalogy plugins install ./extensions/zalo`
   - From npm (if published): `legalogy plugins install @legalogy/zalo`
...
- Approve via:
  - `legalogy pairing list zalo`
  - `legalogy pairing approve zalo <CODE>`
...
- Example: `legalogy message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `legalogy channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `legalogy logs --follow`
