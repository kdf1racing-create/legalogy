...
read_when:
  - You are building a Legalogy plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (legalogy.plugin.json)

Every plugin **must** ship a `legalogy.plugin.json` file in the **plugin root**.
Legalogy uses this manifest to validate configuration **without executing plugin
