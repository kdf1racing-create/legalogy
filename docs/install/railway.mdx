...
Deploy Legalogy on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/legalogy` — Control UI
...
- `LEGALOGY_STATE_DIR=/data/.legalogy` (recommended)
- `LEGALOGY_WORKSPACE_DIR=/data/workspace` (recommended)
- `LEGALOGY_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Legalogy state + workspace so you can migrate to another host without losing config or memory.
