---
summary: "Hubs that link to every Legalogy doc"
read_when:
...
<Note>
If you are new to Legalogy, start with [Getting Started](/start/getting-started).
</Note>
...
- [Legalogy assistant](/start/legalogy)
