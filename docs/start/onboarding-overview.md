---
summary: "Overview of Legalogy onboarding options and flows"
read_when:
...
Legalogy supports multiple onboarding paths depending on where the Gateway runs
...
- [`legalogy onboard` command](/cli/onboard)

## macOS app onboarding

Use the Legalogy app when you want a fully guided setup on macOS. Docs:
