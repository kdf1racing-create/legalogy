---
summary: "First-run onboarding flow for Legalogy (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Legalogy">
...
<Step title="CLI">
  ...
  The app can install the global `legalogy` CLI via npm/pnpm so terminal
