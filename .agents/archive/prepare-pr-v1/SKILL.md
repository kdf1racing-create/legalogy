...
- `fix: <summary> (legalogy#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (legalogy#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "legalogy#$pr_number" || { echo "ERROR: commit subject missing legalogy#$pr_number"; exit 1; }
